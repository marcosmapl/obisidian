...
Os direitos fundamentais **são comuns a todos os seres humanos**,
respeitadas suas **particularidades**.

> [!note] Existem direitos que são outorgados a grupos específicos (como os direitos dos trabalhadores).
...
Os direitos fundamentais são indivisíveis, isto é, não podem ser considerados isoladamente, são um **conjunto único e indivisível de direitos**.
