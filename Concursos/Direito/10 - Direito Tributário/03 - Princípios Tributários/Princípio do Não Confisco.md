...
### Proíbe
  ...
  - tributação **excessiva, desproporcional ou abusiva**;
  - utilização do tributo como **instrumento de punição indireta**;
...
- Considera:
    ...
    - base de cálculo;
    - alíquota;
    - impacto econômico no contribuinte.
...
- **Multas Moratórias**: acima de 20% do valor do tributo.
- **Multas Punitivas**: acima de 100% do valor do tributo.

---
## Relação com Outros Princípios

- **Capacidade Contributiva** → adequação ao poder econômico;
- **Isonomia Tributária** → vedação a desigualdades injustificadas;
- **Legalidade Tributária** → limites formais e materiais à tributação.

---
## Pontos de Prova

- Conceito **indeterminado** (depende de análise concreta);
- STF não fixa percentuais rígidos;
- Incide tanto sobre **tributos** quanto sobre **sanções tributárias**.
