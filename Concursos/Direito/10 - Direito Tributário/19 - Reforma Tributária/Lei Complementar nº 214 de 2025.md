...
> [!note] Art. 2º
>  O IBS e a CBS são informados pelo **PRINCÍPIO DA NEUTALIDADE**, segundo o qual esses tributos devem **evitar distorcer as decisões de consumo e de organização da atividade econômica**, observadas as ==exceções previstas na Constituição Federal e nesta Lei Complementar==.
...
> [!note] O § 8º do art. 156-A, da CF/88 autorizou que a LC definisse o conceito de SERVIÇOS se tornou residual.
...
> [!important] Habitualidade
> Para o fornecedor não existe a obrigação de **habitualidade**.

> [!important] Personalidade jurídica
> Foi incluído no conceito de fornecedor as entidades **sem personalidade jurídica**.
...
> [!tip] Destinatário
> Recebe o bem ou serviço (recebedor).

> [!important] Princípio do Destino
> Com a adoção do **princípio do destino**, o IBS/CBS é **devido no local do consumo**, não mais na origem. Isso busca dar fim à Guerra Fiscal entre as Unidades Federativas.
...
> [!important]  LC 227
>  A **locação**, o **arrendamento** e a **cessão temporária** de bem enquadram-se como operações com bens, e não como serviços. Isso é especialmente relevante para se **definir o local de incidência**.

> [!note] Operação Onerosa
> Aquele em que haja contraprestação, seja financeira ou não.
...
### Base de Cálculo do ITCMD e ITBI
...
---
## Ordem de Prevalência de um Benefício Fiscal

A LC 227 incluiu o art. 7º-A, que estabelece uma ordem de prevalência obrigatória quando mais de um benefício fiscal puder ser aplicado à mesma operação:

Ordem	Benefício Fiscal
1º	Redução a zero de alíquota
2º	Suspensão com conversão em alíquota zero
3º	Isenção
4º	Diferimento
5º	Redução de alíquota distinta da redução a zero

> [!important] **Regra para múltiplas reduções de alíquota**
> - A **aplicação cumulativa** das reduções somente ocorre com **previsão expressa**
> - Não havendo previsão de cumulação, prevalece a **maior redução**
