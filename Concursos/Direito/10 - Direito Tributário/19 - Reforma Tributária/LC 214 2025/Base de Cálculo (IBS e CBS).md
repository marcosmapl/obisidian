...
updated: 2026-07-04T11:05:00
---

## Regra Geral

> [!note] LC 214/2025, Art. 12
> A base de cálculo do IBS e da CBS é o **valor da operação**, ==salvo disposição em contrário prevista nesta Lei Complementar==

> [!warning] Tudo aquilo que for cobrado em virtude da operação **integrará a base de cálculo**, salvo as exceções taxativamente previstas

---
## Elementos que Integram a Base de Cálculo

> [!note] LC 214/2025, Art. 12 § 1º 
...
---
## Elementos Não Integrantes a Base de Cálculo

> [!note] LC 214/2025, Art. 12 § 2º
...
> [!tip] Tributos não integrantes
> IBS, CBS, IPI, ICMS, ISS, PIS, COFINS e Contribuição para Custeio de Sistemas de Monitoramento para Segurança e Preservação de Logradouros Públicos.

---
## Situações Especiais

### Valor da operação expresso em Moeda Estrangeira

**Conversão** em moeda nacional por **taxa de câmbio** apurada pelo **Banco Central do Brasil**

### Devolução ou cancelamento da operação

**Mesma base de cálculo** utilizada na **operação original**

### Transporte internacional de passageiros — trechos de ida e volta vendidos em conjunto

**Metade** do valor cobrado

### Contratação de instrumentos financeiros derivativos fora de condições de mercado que ocultem o valor da operação

O **ganho no derivativo** compõe a **base de cálculo**

### Aquisições de energia elétrica realizadas de forma multilateral

Valor da **liquidação financeira** apurada pela **Câmara de Comercialização de Energia Elétrica (CCEE)**, observada a participação **proporcional** dos estabelecimentos do **agente** ou de seus **representados**
