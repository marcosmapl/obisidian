...
- Entrada **definitiva** (não há obrigação de devolução)
- Destinação ao **atendimento do interesse público**
- Incorporação ao **patrimônio público**

---
## Observação relevante

- Nem todo ingresso é receita pública (ex.: **empréstimos públicos** são ingressos provisórios).
