...
- Administração Pública Direta
	- Poderes Legislativos e Judiciário quando no desempenho da função administrativa
- Autarquias
- Fundações Públicas

> [!important] No caso das Empresas Estatais (EPs e SEMs), embora sejam obrigadas a realizar licitações, não se baseiam na Lei 14.133, mas sim na Lei das Estatatais (Lei nº 13.303/2016).

> [!important] As Empresas Estatais devem utilizar as Lei nº 14.133 para: Critérios de Desempate, Procedimentos de Pregão e Disposições Penais.

![[Pasted image 20260430145710.png]]

---
## Empresas Estatais

- Prestadoras de **serviço público**: Licitar para todas as suas atividades.
- Exploradoras de **atividades econômicas**:
	- **Atividade-meio**: Deve licitar.
...
![[Pasted image 20260430160810.png]]

---
## Objetos Não Licitáveis

![[Pasted image 20260430160834.png]]
...
**XXVIII - EMPREITADA POR PREÇO UNITÁRIO**: contratação de mão de *obra por preço certo de unidades determinadas*.

**XXIX - EMPREITADA POR PREÇO GLOBAL**: contratação da execução da *obra do serviço por preço certo e total*.
...
![[Pasted image 20260430163522.png]]
...
- Listagem dos possíveis *Eventos Supervenientes* à assinatura do contrato.
- Estabelecer as *Obrigações de Resultado* e *Obrigações de Meio*.
...
![[Pasted image 20260430164644.png]]

![[Pasted image 20260430164649.png]]
