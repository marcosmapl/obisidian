...
- Todo tributo desse ser criado por **Lei**
	- **Lei Ordinária**,
	- **Lei Complementar** (em alguns casos);
	- ou **Ato Normativo** que possua a mesma força de lei.
...
- Tributos, diferentemente das **multas**, são cobrados em decorrência de um **fator gerador**.
- Essa cobrança, não possui o objetivo de **punir**, mas sim, de **arrecadar**.

> [!important] Existem tributos cuja função principal não é arrecadação, mas sim, **intervenção em um setor econômico**. São denominados **tributos extrafiscais**.

> [!important] Sobre o rendimento decorrente de atividades ilícitas, deve incidir **imposto de renda** (art. 43, CTN). **Perceba que o tributo não está sendo utilizado como punição,** pois o fato gerador desse tributo ocorreu, e o valor será devido.
---
...
![[Pasted image 20251229231614.png]]
