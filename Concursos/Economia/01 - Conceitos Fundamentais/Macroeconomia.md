...
Classificação
- Consumo das **famílias (C)**: bens adquiridos voluntariamente pelas pessoas no mercado.
- Consumo do **governo (G)**: bens e serviços de uso coletivo colocados à disposição da sociedade pelo setor público (gastos do governo).
...
> [!info] FBKF
> Corresponde ao investimento das empresas em aumento da capacidade produtiva.

> [!info] Variação de Estoque
> Corresponde à variação líquida nos estoques de bens e de matérias-primas utilizadas no processo produtivo.
...
- **Contas Nacionais**: Cálculo do PIB (nominal vs. real), Deflator, e as identidades de Renda e Produto
