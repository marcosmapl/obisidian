...
- Avaliação de Controles: Testar e avaliar a eficácia operacional dos controles internos.

- Desenvolvimento de Achados: Identificar variações em relação aos critérios estabelecidos, analisar suas causas e desenvolver as constatações (achados).

- Identificação de Distorções: Avaliar o efeito de distorções identificadas durante os trabalhos.
...
1. Desenvolver **conclusões e recomendações**.

2. Garantir evidências que deem suporte à **opinião do auditor**.
