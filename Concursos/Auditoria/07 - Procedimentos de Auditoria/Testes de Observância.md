...
- Verificar se os **controles internos**:
    - existem;
    - foram adequadamente **implementados**; e
    - estão sendo **efetivamente aplicados**.
- Sustentar a **avaliação da confiabilidade** dos controles.
...
- **Inspeção**  
    → verificação de **registros, documentos e evidências físicas**.
- **Observação**  
    → acompanhamento de **processos ou atividades** durante sua execução.
- **Investigação e Confirmação**  
    → obtenção de informações por meio de **indagações** a pessoas **internas ou externas** à entidade.
...
- Indicam se os controles:
    - são **confiáveis**; ou
    - apresentam **falhas relevantes**.
- Influenciam:
    - o **nível de risco** avaliado; e
