...
> O **planejamento de auditoria** é a **primeira fase** do processo de auditoria, sendo a etapa fundamental onde se definem os **objetivos** a serem atingidos e os caminhos para alcançá-lo.

> [!important] Normativo base é a **NBC TA 300**

> [!important] Planejamento ==NÃO== é uma **fase isolada**, sendo um processo **contínuo** e **iterativo**. Muitas vezes, iniciando logo após o término da auditoria anterior e seguindo até a conclusão do trabalho atual.
...
O planejamento está delimitado em duas dimensões:

• [[Estratégia Global — Conceito]] ⟶ Nível **amplo**/**estratégico**. 
• [[Plano de Auditoria — Conceito]] ⟶ Nível **restrito**/**operacional**.

> [!important] Auditor pode optar por discutir esses elementos do planejamento com a administração da entidade, contudo, esses elementos continuam sendo de responsabilidade do auditor.
...
- O conhecimento detalhado da **política** e dos **instrumentos de gestão** e **riscos** da entidade.
- O conhecimento detalhado das **atividades operacionais** e dos **sistemas contábil** e dos **controles internos** e seu grau de confiabilidade da entidade.
...
> [!warning] Auxilia na seleção dos **mebros da equipe** de trabalho com níveis apropriados de capacidade e competência para responderem aos **riscos esperados** e na alocação apropriada de tarefas.
...
> [!tip] Auditoria Inicial
> - Aplicar os procedimentos relativos à aceitação do cliente e do trabalho;
...
A natureza e extensão das **atividades de planejamento** variam conforme:
- **Porte e complexidade** da entidade
- Experiência anterior da equipe com a entidade
- Mudança nas circunstâncias que ocorrem durante o trabalho
...
- **Capacidade e competência dos membros** individuais da equipe
...
- **Estratégia Global**
- **Plano de Auditoria**
- Eventuais **alterações significativas** e suas **razões**

---
## Tópicos Relacionados

- [[Estratégia Global — Conceito]]
- [[Plano de Auditoria — Conceito]]
