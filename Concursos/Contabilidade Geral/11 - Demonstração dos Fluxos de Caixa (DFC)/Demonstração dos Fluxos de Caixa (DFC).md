...
- Avaliar liquidez e solvência
- Identificar conversão do lucro em caixa
...
> [!important] CPC 03 (R2)
> Faculta método direto ou indireto. Se a empresa usar o método direto, deve apresentar a conciliação do lucro líquido com o fluxo operacional.

## Pontos de prova

- A DFC não segue o regime de competência como a DRE.
- Transações sem entrada ou saída de caixa não entram no corpo da DFC.
- Juros e dividendos exigem atenção à classificação adotada pela norma e pela banca.
