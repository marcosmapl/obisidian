...
1.1.01 — Caixa  
1.1.01.01 — Caixa Matriz
```

---
## Características que Influenciam no Plano de Contas

- **Tamanho** da empresa
- **Ramo** de atividade
- **Sistema contábil**
- Interesse dos **Usuários** das informações

---
## Requisitos de Excelência

Para ser considerado como um plano de excelência, o plano de contas deve:
- Ser **Adaptável**
- Possuir uma **Unidade Técnica** (nomenclaturas e funcionamento)
- Ser **Claro**
- Ser **Flexível**
